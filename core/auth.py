...
def try_hex_to_int(valor_hex: str) -> int:
    """
    Tenta converter e retornar um valor hexa p/inn ou devolve 0
    """
    try:
...
def verificar_senha(senha: str, hash_senha: str) -> bool:
    """
    Função que verifica se a senha é igual ao hash contido no banco de dados
    """
...
def get_membro_id(request: Request) -> Optional[int]:
    ...
    partes = valor.split('.')
    #Pega a parte correspondente ao membro_id
    membro_id_hex: str = partes[0]
    #Converte de Hexa para Int
